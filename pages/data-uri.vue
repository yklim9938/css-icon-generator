            ...
            <div class="mt-4 mx-auto max-w-[600px]">
                ...
                <div class="mt-4">
                    <div class="flex gap-4 flex-col sm:flex-row">
                        <div class="size-[150px] mx-auto flex-shrink-0 border border-line rounded bg-center bg-contain bg-no-repeat flex items-center justify-center" :style="preview">
