        ...
        <div v-if="preview" class="previewer p-6 mt-[50px]" :class="{show: preview}">
            <div class="mx-auto max-w-[800px]">
                <div class="mb-6 prose">
                    <h3 class="text-primary font-bold text-2xl">How to Use</h3>
                    <ol>
                        <li><a href="javascript:void(0)" class="text-primary" onclick="codeModal.showModal()">Copy</a> and paste the code into your project.</li>
                ...
                <div class="mb-6">
                    <h3 class="text-primary font-bold text-2xl">Your Generated Icons</h3>
                    <p class="text-xs mt-2">*Click on the icons to toggle <code class="text-secondary">.color</code> class.</p>
                </div>
                ...
                <div class="mt-7">
                    ...
                    <button class="btn w-full mt-4" @click="backToStep1">Back</button>
                </div>
            </div>
            ...
            <dialog id="codeModal" class="modal">
                <div class="modal-box max-w-[700px]">
                    ...
                    <div class="mt-6">
                        <textarea class="code-area w-full h-[300px] resize-none textarea !textarea-primary textarea-xs !cursor-text !text-base-content" disabled></textarea>
                        <CopyButton class="btn btn-primary w-full mt-4 uppercase" :text-to-copy="iconStyle?.innerHTML">Copy</CopyButton>
                    </div>
                </div>
